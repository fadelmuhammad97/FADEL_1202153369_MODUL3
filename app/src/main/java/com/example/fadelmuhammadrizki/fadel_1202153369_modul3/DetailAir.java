...
public class DetailAir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mengakses gambar, nama, detail, ukuran, battery yang ada pada layout tersebut
